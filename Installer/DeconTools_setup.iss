...
AppName=DeconTools
[Messages]
WelcomeLabel2=This will install [name/ver] on your computer.%n%n%n%nNOTICE:%nSome source files require access to a 32-bit ProteoWizard installation. Please install 32-bit ProteoWizard before using the program to avoid errors.%n%n
; Example with multiple lines:
; WelcomeLabel2=Welcome message%n%nAdditional sentence
[Files]
Source: DeconConsole\bin\x86\Release\DeconConsole.exe                                                                                             ; DestDir: {app}
Source: DeconConsole\bin\x86\Release\DeconConsole.exe.config                                                                                      ; DestDir: {app}

Source: DeconTools.Backend\bin\x86\Release\DeconTools.Backend.dll                                                                                 ; DestDir: {app}
Source: DeconTools.Backend\bin\x86\Release\MathNet.Numerics.dll                                                                                   ; DestDir: {app}

Source: DeconToolsAutoProcessV1\bin\x86\Release\DeconToolsAutoProcessV1.exe                                                                       ; DestDir: {app}
Source: DeconToolsAutoProcessV1\bin\x86\Release\DeconToolsAutoProcessV1.exe.config                                                                ; DestDir: {app}

Source: DeconTools.Backend\bin\x86\Release\x64\SQLite.Interop.dll                                                                                 ; DestDir: {app}\x64
...
Source: DeconTools.Backend\bin\x86\Release\log4net.dll                                                                                                                       ; DestDir: {app}
...
Source: Library\DLLsToBeCopied\Interop.EDAL.SxS.manifest                                                                                          ; DestDir: {app}
...
Source: Library\MultiAlignEngine.dll                                                                                                              ; DestDir: {app}
...
Source: "Library\Agilent_D\MassHunter DataAccess Component MHDAC B.06.00\MassHunterDataAccessAssembly_32bit\bin\agtsampleinforw.dll"              ; DestDir: {app}
Source: "Library\Agilent_D\MassHunter DataAccess Component MHDAC B.06.00\MassHunterDataAccessAssembly_32bit\bin\BaseCommon.dll"                   ; DestDir: {app}
Source: "Library\Agilent_D\MassHunter DataAccess Component MHDAC B.06.00\MassHunterDataAccessAssembly_32bit\bin\BaseDataAccess.dll"               ; DestDir: {app}
Source: "Library\Agilent_D\MassHunter DataAccess Component MHDAC B.06.00\MassHunterDataAccessAssembly_32bit\bin\BaseTof.dll"                      ; DestDir: {app}
Source: "Library\Agilent_D\MassHunter DataAccess Component MHDAC B.06.00\MassHunterDataAccessAssembly_32bit\bin\MassSpecDataReader.dll"           ; DestDir: {app}
