...
namespace DeconTools.Backend.Utilities.IsotopeDistributionCalculation.TomIsotopicDistribution
{
    ...
    public class TomIsotopicPattern
    {
        ...
        private void initializeVariables()
        {
            ...
            afHa = new[] { fH1a, fH2a };
            afCa = new[] { fC12a, fC13a };
            afNa = new[] { fN14a, fN15a };
            afNna = new[] { fNn14a, fNn15a };
            afOa = new[] { fO16a, fO18a };  // ignore below 0.1%
            afSa = new[] { fS32a, fS34a };  // ignore below 1%
            aafIsos = new[] { afCa, afHa, afNa, afOa, afSa };       //[Gord]  - I adjusted the order
            aafN15Isos = new[] { afCa, afHa, afNna, afOa, afSa };
            afHm = new[] { fH1m, fH2m };
            afCm = new[] { fC12m, fC13m };
            afNm = new[] { fN14m, fN15m };
            afOm = new[] { fO16m, fO18m };  // ignore below 0.1%
            afSm = new[] { fS32m, fS34m };  // ignore below 1%
            aafIsosm = new[] { afHm, afCm, afNm, afOm, afSm };
       ...
       // double fS35a = 0.0002f;
        ...
        double[] afAvn;
        private readonly PeptideUtils _peptideUtils;
        ...
        private int getAtomCount(IReadOnlyDictionary<string, int> elementTable, string elementSymbol)
        {
