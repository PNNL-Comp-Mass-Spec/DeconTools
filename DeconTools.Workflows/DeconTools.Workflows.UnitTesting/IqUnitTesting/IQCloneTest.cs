...
namespace DeconTools.Workflows.UnitTesting.IqUnitTesting
{
    ...
    //        var executor = new IqExecutor(executorParameters, run) {ChromSourceDataFilePath = peaksTestFile};
    ...
    //        IqTarget clonedTarget =  util.DeepClone(sampleTarget);
