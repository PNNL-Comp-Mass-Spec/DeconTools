    ...
    public class SipperResultToLcmsFeatureExporter : TargetedResultToTextExporter
    {
        ...
        protected override string addAdditionalInfo(TargetedResultDTO result)
        {
            ...
            var data = new List<string>
            {
                ...
                sipperResult.NumCarbonsLabelled.ToString("0.000"),
                sipperResult.PercentCarbonsLabelled.ToString("0.00"),
                sipperResult.PercentPeptideLabelled.ToString("0.00"),
        ...
        protected override string buildHeaderLine()
        {
            var data = new List<string>
            {
                ...
                "ChromCorrStdev",
                "NumCarbonsLabelled",
                "PercentCarbonsLabelled",
                "PercentPeptidesLabelled",
                "ContigScore",
                "RSquared",
                "ValidationCode"
            };
