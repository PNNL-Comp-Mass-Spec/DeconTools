...
namespace DeconTools.UnitTesting2
{
    public class FileRefs
    {
        ...
        public class ParameterFiles
        {
            ...
            public static string Orbitrap_Scans6000_6050ParamFile = FileRefs.RawDataBasePath + @"\ParameterFiles\LTQ_Orb\LTQ_Orb_SN2_PeakBR1pt3_PeptideBR1_Thrash_scans6000_6050.xml";
        }
